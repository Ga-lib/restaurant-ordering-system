...
function Cart() {
  ...
  async function handleApplyPromo() {
    ...
    try {
      ...
      showToast(`Promo code ${result.code} applied`);
    } catch (err) {
  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-screen relative" style={{ backgroundColor: "var(--bg-app)" }}>
        <PageBackground type="image" src="/images/cart-bg.jpg" />
        <div className="relative z-20 p-4 lg:p-6">
          <div className="liquid-glass-strong rounded-3xl">
            <Navbar />
          </div>
        </div>
        <div className="relative z-10 flex flex-col items-center justify-center gap-4 py-32">
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: "var(--bg-app)" }}>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-10">
        ...
        <h1 className="text-5xl" style={{ fontWeight: 500, letterSpacing: "-0.02em", color: "var(--text-primary)" }}>
